...
> **Multi-entorno:** todos los entornos comparten el realm `osfatun`. La separación de acceso se logra con grupos de entorno (`ENT-Desarrollo`, `ENT-QA`, etc.) en las políticas de Pomerium. Ver `documentacion/multi-entorno.md`.
